...
/// An implementation of [FlutterLiveActivitiesbPlatform] that uses method channels.
class MethodChannelFlutterLiveActivitiesb
    extends FlutterLiveActivitiesbPlatform {
  /// The method channel used to interact with the native platform.
  final MethodChannel _methodChannel =
      const MethodChannel('flutter_live_activitiesb');
  final EventChannel _eventChannel =
      const EventChannel('flutter_live_activitiesb/event');
